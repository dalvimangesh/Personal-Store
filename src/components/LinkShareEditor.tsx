...
import { Loader2, Trash2, Plus, GripVertical, Copy, ExternalLink } from "lucide-react";
    ...
    <div className="flex flex-col h-full gap-4 w-full">
        ...
        <div className="flex flex-col gap-2">
            {items.map((item, index) => {
                ...
                return (
                    <div key={index} className="flex flex-col sm:flex-row gap-2 items-start sm:items-center group p-3 sm:p-0 border sm:border-0 rounded-lg bg-muted/10 sm:bg-transparent w-full">
